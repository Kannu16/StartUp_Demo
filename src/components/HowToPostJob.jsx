...
const Pacakages = () => {
  return (
    <>
      <div className="packages-container bg-dark">
        <div className="container">
          <div
            className="post-find-job d-flex justify-content-between align-items-center"
            style={{ height: "200px" }}
          >
            <div className="left d-flex flex-column">
              <h3 className="" style={{ color: "#FBEBD9" }}>
          ...
          <div className="how-to-post-job d-flex justify-content-between pb-5">
            <div className="div1 p-2 rounded d-flex flex-column align-items-center" style={{ backgroundColor: "#FBEBD9", width:"23%" }}>
             <span className="shadow border border-dark p-3 rounded-circle">
             <svg
                width="46"
                height="46"
                className="u-svg-ico c-icon__content"
                role="img"
              ...
              <p className="mt-4 fs-5 fw-semibold">Post a Job</p>
              <span className="text-center fs-6">
                Create your free job posting and start receiving Quotes within
                hours.
              </span>
            </div>
            <div className="div2 p-2 rounded d-flex flex-column align-items-center" style={{ backgroundColor: "#FBEBD9", width:"23%" }}>
             <span className="shadow border border-dark p-3 rounded-circle">
             <svg
                width="46"
                height="46"
              ...
              <p className="mt-4 fs-5 fw-semibold">Hire Freelancers</p>
              <span className="text-center fs-6">
                Compare the Quotes you receive and hire the best freelance
                professionals for the job.
              </span>
            </div>
            <div className="div3 p-2 rounded d-flex flex-column align-items-center" style={{ backgroundColor: "#FBEBD9", width:"23%" }}>
              <span className="shadow border border-dark p-3 rounded-circle">  <svg
                width="46"
                height="46"
                className="u-svg-ico c-icon__content"
                role="img"
                aria-label="Get to work"
              >
              ...
              <p className="mt-4 fs-5 fw-semibold">Get Work Done</p>
              <span className="text-center fs-6">
                Decide on how and when payments will be made and use WorkRooms
                to collaborate, communicate and track work.
              </span>
            </div>
            <div className="div4 p-2 rounded d-flex flex-column align-items-center " style={{ backgroundColor: "#FBEBD9", width:"23%" }}>
             <span className="shadow border border-dark p-3 rounded-circle">  <svg
                width="46"
                height="46"
                className="u-svg-ico c-icon__content"
              ...
              <p className="mt-4 fs-5 fw-semibold">Make Secure Payments</p>
              <span className="text-center fs-6">
